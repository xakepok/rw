...
<script type="text/javascript">
    Joomla.submitbutton = function (task) {
        if (task === 'stationdir.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {*/
    ...
    <div class="row-fluid">
        <div class="span12 form-horizontal">
            ...
            <div class="tab-content">
                <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::sprintf('COM_RW_BLANK_STATION_DIRECTION_ASSET')); ?>
                <div class="row-fluid">
                    <div class="span12">
                        <div>
